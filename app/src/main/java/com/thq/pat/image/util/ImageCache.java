...
public class ImageCache {
     ...
     * one is created with defaults and saved to a {@
import com.bysj.PurePicture.BuildConfig;link RetainFragment}.
     *
    ...
    public static ImageCache findOrCreateCache(
            final Context activity, final String uniqueName) {
     ...
     */
    public static ImageCache findOrCreateCache(
            final Context activity, ImageCacheParams cacheParams) {
