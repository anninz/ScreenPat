 ...
 *
 * @attr ref android.R.styleable#GestureBuilder_eventsInterceptionEnabled
 * @attr ref android.R.styleable#GestureBuilder_fadeDuration
 * @attr ref android.R.styleable#GestureBuilder_fadeOffset
 * @attr ref android.R.styleable#GestureBuilder_fadeEnabled
 * @attr ref android.R.styleable#GestureBuilder_gestureStrokeWidth
 * @attr ref android.R.styleable#GestureBuilder_gestureStrokeAngleThreshold
 * @attr ref android.R.styleable#GestureBuilder_gestureStrokeLengthThreshold
 * @attr ref android.R.styleable#GestureBuilder_gestureStrokeSquarenessThreshold
 * @attr ref android.R.styleable#GestureBuilder_gestureStrokeType
 * @attr ref android.R.styleable#GestureBuilder_gestureColor
 * @attr ref android.R.styleable#GestureBuilder_orientation
 * @attr ref android.R.styleable#GestureBuilder_uncertainGestureColor
 */
public class GestureBuilder {

    static String TAG = "THQ1";
    ...
    public GestureBuilder(Context context) {
        init();
    }

//    public GestureBuilder(Context context, AttributeSet attrs) {
//        this(context, attrs, com.android.internal.R.attr.gestureOverlayViewStyle);
//    }
//
//    public GestureBuilder(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
 ...
 /*    public GestureBuilder(
       ...
       final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.GestureBuilder, defStyleAttr, defStyleRes);

        mGestureStrokeWidth = a.getFloat(R.styleable.GestureBuilder_gestureStrokeWidth,
                mGestureStrokeWidth);
        mInvalidateExtraBorder = Math.max(1, ((int) mGestureStrokeWidth) - 1);
        mCertainGestureColor = a.getColor(R.styleable.GestureBuilder_gestureColor,
                mCertainGestureColor);
        mUncertainGestureColor = a.getColor(R.styleable.GestureBuilder_uncertainGestureColor,
                mUncertainGestureColor);
        mFadeDuration = a.getInt(R.styleable.GestureBuilder_fadeDuration, (int) mFadeDuration);
        mFadeOffset = a.getInt(R.styleable.GestureBuilder_fadeOffset, (int) mFadeOffset);
        mGestureStrokeType = a.getInt(R.styleable.GestureBuilder_gestureStrokeType,
                mGestureStrokeType);
        mGestureStrokeLengthThreshold = a.getFloat(
                R.styleable.GestureBuilder_gestureStrokeLengthThreshold,
                mGestureStrokeLengthThreshold);
        mGestureStrokeAngleThreshold = a.getFloat(
                R.styleable.GestureBuilder_gestureStrokeAngleThreshold,
                mGestureStrokeAngleThreshold);
        mGestureStrokeSquarenessTreshold = a.getFloat(
                R.styleable.GestureBuilder_gestureStrokeSquarenessThreshold,
                mGestureStrokeSquarenessTreshold);
        mInterceptEvents = a.getBoolean(R.styleable.GestureBuilder_eventsInterceptionEnabled,
                mInterceptEvents);
        mFadeEnabled = a.getBoolean(R.styleable.GestureBuilder_fadeEnabled,
                mFadeEnabled);
        mOrientation = a.getInt(R.styleable.GestureBuilder_orientation, mOrientation);
    ...
    public void setGesture(Gesture gesture) {
        ...
        mPath.rewind();
        mPath.addPath(path, -bounds.left + (1280 - bounds.width()) / 2.0f,
                -bounds.top + (1920 - bounds.height()) / 2.0f);
...
//        final float x = event.getX();//delete by hongqi
//        final float y = event.getY();
    ...
    private void fireOnGesturePerformed() {
        ...
        for (int i = 0; i < count; i++) {
            actionListeners.get(i).onGesturePerformed(GestureBuilder.this, mCurrentGesture);
        }
    }
...
//            invalidate();
    ...
    public static interface OnGesturingListener {
        void onGesturingStarted(GestureBuilder overlay);

        void onGesturingEnded(GestureBuilder overlay);
    }

    public static interface OnGestureListener {
        void onGestureStarted(GestureBuilder overlay, MotionEvent event);

        void onGesture(GestureBuilder overlay, MotionEvent event);

        void onGestureEnded(GestureBuilder overlay, MotionEvent event);

        void onGestureCancelled(GestureBuilder overlay, MotionEvent event);
    }

    public static interface OnGesturePerformedListener {
        void onGesturePerformed(GestureBuilder overlay, Gesture gesture);
    }
