...
//        return (double)(y1 - y)/(x1 - x);
    ...
    public static void init(IPlugAPI iPlugAPI){
       WindowManager mWindowManager = (WindowManager)iPlugAPI.getApplication().getSystemService(iPlugAPI.getApplication().WINDOW_SERVICE);
