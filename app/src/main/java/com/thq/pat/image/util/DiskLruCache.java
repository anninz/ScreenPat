...
import com.thq.pat.BuildConfig;
...
public class DiskLruCache {
    ...
    private static final String CACHE_FILENAME_PREFIX = "cache_";//缓冲文件前缀
    private static final int MAX_REMOVALS = 4;
    private static final int INITIAL_CAPACITY = 32;//初始容量
    private static final float LOAD_FACTOR = 0.75f;

    private final File mCacheDir;
    private int cacheSize = 0;
    private int cacheByteSize = 0;
    private final int maxCacheItemSize = 64; // 默认64项
    private long maxCacheByteSize = 1024 * 1024 * 5; // 5MB 
    private CompressFormat mCompressFormat = CompressFormat.JPEG;//压缩格式
    private int mCompressQuality = 70;

    private final Map<String, String> mLinkedHashMap =
            Collections.synchronizedMap(new LinkedHashMap<String, String>(//同步的集合包装器 
    ...
    public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize) {
        ...
        if (cacheDir.isDirectory() && cacheDir.canWrite()//正确路径并且能写
    ...
    public static String createFilePath(File cacheDir, String key) {
        try {
            ...
            // this example
            return cacheDir.getAbsolutePath() + File.separator +//系统目录中的间隔符
